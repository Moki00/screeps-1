...
export default function getMostFilledHarvesterContainer(creep: Creep): StructureContainer | undefined {
    return first(
        creep.room
            ...
            .filter((structure) => {
                ...
                return structure.structureType === STRUCTURE_CONTAINER && isItHarvestersContainer;
            })
            .sort((a, b) => {
